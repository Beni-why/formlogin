        ...
        <div class="row">
          <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
            <div class="login-brand">
              <img src="<?= base_url('template') ?> /assets/img/avatar.png" alt="logo" width="100" class="shadow-light rounded-circle">
            </div>
              ...
              <div class="card-body">
                ...
                methot="POST">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-6">
                      <label for="password" class="d-block">Masukan Ulang Password</label>
            ...
            <div class="simple-footer">
              Copyright &copy; Beni wahyono 2020
            </div>
          </div>
        </div>
      </div>
